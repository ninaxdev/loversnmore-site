<!-- Mobile Bottom Navigation - Loversnmore Gradient - Only visible on mobile when enable_new_navigation is true -->
@if(env('ENABLE_NEW_NAVIGATION') === 'true' || env('ENABLE_NEW_NAVIGATION') === true)
<nav class="fixed bottom-0 left-0 right-0 shadow-lg md:hidden" style="background: linear-gradient(90deg, #4F1DA1, #E78AB0); z-index: 99999 !important;">
