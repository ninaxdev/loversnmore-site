...
<div class="row">
     <!-- Nav tabs -->
    <div class="col-xl-12 lw-nav-tabs-inactive">
        <!-- Nav tabs -->
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link <?= $languageType == "translated" ? 'active' : '' ?>" id="translated-tab" role="tab"
                    href="<?= route('manage.translations.lists', [ 'languageId' => $languageInfo['id'], 'languageType' => 'translated']) ?>#language">
                    <?= __tr('All') ?>
                 </a>
            ...
            <li class="nav-item">
                <a class="nav-link <?= $languageType == "untranslated" ? 'active' : '' ?>" id="untranslated-tab" role="tab"
                    href="<?= route('manage.translations.lists', [ 'languageId' => $languageInfo['id'], 'languageType' => 'untranslated']) ?>#language">
                    <?= __tr('Untranslated Only') ?>
                 </a>
            </li>
        </ul>
        <br>
    ...
    <div class="col-xl-12 mb-4 <?= $languageInfo['is_rtl'] ? 'lw-lang-direction-rtl' : 'lw-lang-direction-ltr' ?>">
            <!-- check if language type translated -->
            @if($languageType== "translated")
        <?php $lineCount = 1; ?>
        ...
        @endforeach
             <!-- manage untranslated data string-->
             @elseif($languageType== "untranslated")
             @include('translation.partial-untranslated-list')
             @endif
    </div>
</div>
